...
{
    /// <summary>
    /// 运行SeeModsConsoleRun控制台指令(可确保它是工作的)
    /// </summary>
    public interface RunCommandTo
    {
        /// <summary>
        /// 返回运行的命令参数头
        /// </summary>
        ...
        /// <param name="cw">窗体控制台执行</param>
        /// <returns>执行命令的返回，默认0</returns>
        int Execute(string arg, SeeModsConsoleRun r, ConsoleShowWindow cw, object obj);
        /// <summary>
        /// 解释命令
        /// </summary>
